...
if __name__ == "__main__":
    ...
    agent_outputs = simulator.run_simulation(
        number_of_tasks=25, enable_threading=True, max_workers=10)

    # Evaluate the agent
    evaluation_results = simulator.evaluate()
    with open(f'/srv/CS_245_Project/example/gemini_keith_agent_memory_evaluation_results.json', 'w') as f:
